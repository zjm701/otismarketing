...
window.onload=function(){ 
	document.getElementById("downLoadLinkTd").innerHTML = document.getElementById("downLoadLink").value;
            ...
            <div class="result-content">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <td>
                                <input class="common-text required" id="versionNameInput" name="versionName" size="30" value="${versionName}" type="text">
                            </td>
                        	<tr>
